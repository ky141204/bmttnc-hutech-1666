...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_encrypt.clicked.connect(self.call_api_vigenere_encrypt)
        self.ui.btn_decrypt.clicked.connect(self.call_api_vigenere_decrypt)
    ...
    def call_api_vigenere_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                msg.setText("Vigenère Encrypted Successfully")
                msg.exec_()
            else:
    ...
    def call_api_vigenere_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Vigenère Decrypted Successfully")
                msg.exec_()
            else:
                print("Error while calling API")
        except requests.exceptions.RequestException as e:
